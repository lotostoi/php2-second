...
class __TwigTemplate_7b3040c74a9d8c67b6c85bcc98012ae9c1d4495a668bc2c0fa1d87a5845de5f8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t<input type=\"hidden\" name=\"folderImg\" value=\"";
        // line 4
        echo twig_escape_filter($this->env, ($context["folderImg"] ?? null), "html", null, true);
        echo "\">
...
\t\t\t\t\tВ этом разделе вы можете посмотреть некоторые мои работы_
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
";
    ...
    {
        return array (  165 => 56,  156 => 53,  153 => 52,  144 => 50,  140 => 49,  133 => 45,  124 => 42,  120 => 40,  116 => 39,  113 => 38,  108 => 35,  105 => 34,  101 => 32,  99 => 31,  93 => 27,  84 => 24,  79 => 22,  76 => 21,  72 => 20,  53 => 4,  50 => 3,  46 => 2,  35 => 1,);
    }
...
\t\t<input type=\"hidden\" name=\"folderImg\" value=\"{{folderImg}}\">
\t\t<div class=\"common-header__fone\">
\t\t\t<div class=\"common-header__cont\">
\t\t\t\t<h1 class=\"common-header__h1\">Мои работы_</h1>
\t\t\t\t<div class=\"common-header__description\">
...
\t\t\t\t\t<div class=\"product\">
\t\t\t\t\t\t<div class=\"img\">
\t\t\t\t\t\t\t<img src=\"{{folderImg}}{{work.img}}\" alt=\"{{work.title}}\" width=\"417\" height=\"292\">
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<p class=\"title\">
\t\t\t\t\t\t\t{{work.title}}</p>
\t\t\t\t\t\t<div class=\"tags\">
...
{% endblock %}
", "portfolio/portfolio.twig", "D:\\PHP\\open_server_5_3_7_basic\\OpenServer\\domains\\php2-second\\twigViews\\portfolio\\portfolio.twig");
    }
}
