...
/* resume/resume.twig */
class __TwigTemplate_6cc1968dcd9724274c10e5334550ad8b674ec9e24cc722d505e1f19a48dd10aa extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<p class=\"content\">Меня зовут Плотников Алексндр Александрович, мне 37 лет. Проживаю в городе Артеме Приморского края (пригород Владивостока). В 2005 году с отличием, закончил <a href=\"https://www.dvfu.ru/\" class=\"link\" target=\"_blank\">ДВПИ имени В.В.Куйбышева</a>. Являюсь магистром техники и технологии по направлению «Приборостроение». В 2013 году защитил кандидатскую диссертацию по специальности - «Акустика». В течении последних 15 лет работаю в <a href=\"https://www.poi.dvo.ru/\" class=\"link\" target=\"_blank\">ТОИ ДВО РАН</a>. На данный момент являюсь старшим научным сотрудником лаборатории «Физики геосфер», и занимаюсь разработкой лазерно-интерференционных измерительных систем, для мониторинга волновых процессов в различных геосферах.
\t\t\t\t</p>
\t\t\t</section>
...
\t\t\t\tвы может ознакомиться с отзывами от некоторых студентов с которыми я работал. Так же при необходимости могу показать все отзывы, оставленные студентами в системе GeekBrains.</p>
\t\t</section>
...
\t\t\t<p class=\"content\">
\t\t\t\tС начала 2020 года изучаю английский язык в онлайн школе <a href=\"https://skyeng.ru/\" class=\"link\" target=\"_blank\">Skyeng</a>. Занимаюсь три раза в неделю. Поскольку начальные знания языка у меня были очень слабые, на данный момент занимаюсь на ступени Pre-Intermediate.</p>
\t\t</section>
\t\t<section class=\"resume__block\" id=\"softSkills\">
\t\t\t<h2 class=\"title\">Мои интересы_</h2>
\t\t\t<p class=\"content\">На данный момент ищу удаленную работу, с гарантированной занятостью около 4-ч часов в день. Основная цель развитие и получение опыта в разработке реальных проектов. Мне нравится верстать, однако наибольший интерес вызывает работа с js, Vue.js и node.js (готов изучать React). Таким образом на данный момент js мне ближе чем php, тем не менее я готов работать и развиваться и на стороне php.  </p>
\t\t</section>
\t</div>
...
", "resume/resume.twig", "D:\\PHP\\open_server_5_3_7_basic\\OpenServer\\domains\\php2-second\\twigViews\\resume\\resume.twig");
    }
}
